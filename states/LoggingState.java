...
public class LoggingState extends State {
    ...
    public LoggingState() {
        textBoxs[0] = new TextBox(Settings.width / 2, Settings.height * 2 / 6, 500, 50, "Correo", 16);
        textBoxs[1] = new TextBox(Settings.width / 2, Settings.height * 3 / 6, 500, 50, "Password", 16, true);
    ...
    public void draw(Graphics g) {
        ...
        Text.drawText(g, "Inicio de Sesión", Settings.width / 2, Settings.height * 1 / 6, true,
